...
export const permissionRows = [
  {
    ...
    role: 'Administrator',
    roleCode: 'System Wide',
    department: 'Information Technology',
    modules: ['Dashboard', 'Users', 'Master', 'Convert', 'Chart'],
    level: 'Full Access',
    levelKey: 'active',
    status: 'Active',
    statusKey: 'active',
  ...
  },
  {
    ...
    department: 'Procurement',
    modules: ['Vendor Portal', 'Approval', 'Tickets'],
    level: 'Full Access',
    levelKey: 'active',
    status: 'Active',
    statusKey: 'active',
