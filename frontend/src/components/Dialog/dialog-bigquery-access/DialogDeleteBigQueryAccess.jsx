...
function DialogDeleteBigQueryAccess({
  isOpen = false,
  eyebrow = 'Master Data',
  record = null,
  loading = false,
  ...
  const dialogNode = (
    <div className="dashboard-popup-overlay" role="presentation" onClick={handleOverlayClick}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="dialog-delete-bigquery-access-title"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="dashboard-popup__header">
          <div>
            <p className="dashboard-popup__eyebrow">{eyebrow}</p>
            <h2 className="dashboard-popup__title" id="dialog-delete-bigquery-access-title">
              Hapus Akses Dataset
            </h2>
          </div>
        ...
        <div className="dashboard-popup__body">
          <div className="dashboard-popup__notice">
            ...
            <p>
              Hapus akses dataset{' '}
              <strong>{record?.dataset_id}</strong> untuk scope{' '}
              <strong>
                {record?.scope_type} · {record?.scope_name ?? record?.scope_id}
              </strong>
...
export default DialogDeleteBigQueryAccess
